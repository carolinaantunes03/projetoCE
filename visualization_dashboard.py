...
# ********************************************************************************
# ACKNOWLEDGEMENTS
# The majority of the code in this file was generated by Claude Sonnet 3.7.
# It only served as a tool to keep track of the progress of the project.
# The code was generated in a collaborative manner, with the user providing
# feedback and suggestions to improve the code.
# ********************************************************************************

# To run: "streamlit run visualization_dashboard.py"
